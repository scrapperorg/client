...
export const ChangePasswordModal = (props: ChangePasswordModalProps) => {
  ...
  const { form, successMessage, handleSubmit, setSuccessMessage } =
  ...
  return (
    <StandardModal isOpened={isOpened} closeModal={onCloseModal}>
      <ChangePasswordForm form={form} handleSubmit={handleSubmit} successMessage={successMessage} />
    </StandardModal>
  );
};
