            ...
            <Grid item md={10}>
                <Card>
                    <CardContent>
                        ...
                        <Grid container spacing={4}>
                            <Grid item md={4}>
                                <Typography variant="h4" sx={{mb: 3}}>Format original:</Typography>
                                <Typography variant="h4" sx={{mb: 3}}>Nr de pagini:</Typography>
                                <Typography variant="h4" sx={{mb: 3}}>Articole Identificate:</Typography>
                                <Typography variant="h4" sx={{mb: 3}}>Termeni identificati:</Typography>
                            </Grid>
                            <Grid item md={4}>
                                <Typography variant="h5" sx={{mb: 3}}>Not yet implemented</Typography>
                                <Typography variant="h5" sx={{mb: 3}}>Not yet implemented</Typography>
                                <Typography variant="h5" sx={{mb: 3}}>Not yet implemented</Typography>
                                <Typography variant="h5" sx={{mb: 3}}>Not yet implemented</Typography>
                            </Grid>
